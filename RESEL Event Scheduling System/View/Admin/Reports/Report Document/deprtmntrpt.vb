...
Public Class deprtmntrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RESEL_Event_Scheduling_System.deprtmntrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cacheddeprtmntrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As deprtmntrpt = New deprtmntrpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
