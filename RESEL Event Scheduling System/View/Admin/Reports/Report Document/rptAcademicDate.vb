...
Public Class rptAcademicDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RESEL_Event_Scheduling_System.rptAcademicDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAcademicDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAcademicDate = New rptAcademicDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
