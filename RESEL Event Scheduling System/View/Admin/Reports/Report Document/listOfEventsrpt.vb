...
Public Class listOfEventsrpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RESEL_Event_Scheduling_System.listOfEventsrpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedlistOfEventsrpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As listOfEventsrpt = New listOfEventsrpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
