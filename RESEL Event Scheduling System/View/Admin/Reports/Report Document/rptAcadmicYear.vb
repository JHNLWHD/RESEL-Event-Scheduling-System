...
Public Class rptAcadmicYear
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RESEL_Event_Scheduling_System.rptAcadmicYear.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAcadmicYear
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAcadmicYear = New rptAcadmicYear()
        rpt.Site = Me.Site
        Return rpt
    End Function
